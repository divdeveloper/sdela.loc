...
(function ($) {
	...
	window.w2dc_ajax_listings_loader_show = function (controller_hash, scroll_to_anchor) {
		if (scroll_to_anchor) {
			...
			$('html,body').animate({
				scrollTop: scroll_to_anchor.offset().top - sticky_scroll_toppadding
			}, 'slow');
		}
	...
	$('body').on('click', '.w2dc-list-view-btn', function () {
		...
		if (listings_block.hasClass('w2dc-listings-grid')) {
			listings_block.find('.w2dc-listings-block-content').fadeTo("fast", 0, function () {
				...
				$.cookie("w2dc_listings_view_" + hash, 'list', {
					expires: 365,
					path: "/"
				});
			});
	...
	$('body').on('click', '.w2dc-grid-view-btn', function () {
		...
		if (!listings_block.hasClass('w2dc-listings-grid')) {
			listings_block.find('.w2dc-listings-block-content').fadeTo("fast", 0, function () {
				...
				w2dc_equalColumnsHeight();
				$.cookie("w2dc_listings_view_" + hash, 'grid', {
					expires: 365,
					path: "/"
				});
			});
			...
			$.ajax({
				...
				success: function (response) {
					...
					if (['updated', 'added'].indexOf(response.status) >= 0) {
						...
						jqelement = $('<div/>', {
							class: 'col-xs-3 w2dc-user-' + response.user.id,
							append: $('<img/>', {
	...
	*/
	...
	function w2dc_drawFreeHandPolygon(unique_map_id) {
		...
		google.maps.event.addListenerOnce(w2dc_maps[unique_map_id], 'mouseup', function (e) {
			...
			for (lat_lng in ArrayforPolygontoUse) {
				geo_poly.push({
					'lat': ArrayforPolygontoUse[lat_lng].lat(),
					'lng': ArrayforPolygontoUse[lat_lng].lng()
				});
			}
				...
				if (w2dc_google_maps_objects.address_autocomplete_code != '0')
					var options = {
						componentRestrictions: {
							country: w2dc_google_maps_objects.address_autocomplete_code
						}
					};
				else
					var options = {};
					...
					$(editButton).click(function (e) {
						...
						if (this.editing_state == 0) {
							...
							if (typeof w2dc_polygons[unique_map_id] != 'undefined') {
								w2dc_polygons[unique_map_id].setOptions({
									'editable': true
								});
							}
							...
							if (typeof w2dc_polygons[unique_map_id] != 'undefined') {
								...
								for (lat_lng in theArrayofLatLng) {
									geo_poly.push({
										'lat': theArrayofLatLng[lat_lng].lat(),
										'lng': theArrayofLatLng[lat_lng].lng()
									});
								}
	...
	function w2dc_geocodeStartAddress(map_attrs, map, zoom_level) {
		function _geocodeStartAddress() {
			...
			geocoder.geocode({
				'address': map_attrs.start_address
		...
		if (navigator.geolocation) {
			...
			for (var unique_map_id in w2dc_maps_attrs) {
				if (typeof w2dc_maps_attrs[unique_map_id].geolocation != 'undefined' && w2dc_maps_attrs[unique_map_id].geolocation == 1) {
					geolocation_maps.push({
						'map': w2dc_maps[unique_map_id],
						'map_id': unique_map_id
					});
				}
			}
	...
	window.w2dc_scrollToListing = function (anchor, unique_map_id) {
		...
		if (!scroll_to_anchor.parent().parent().parent().hasClass('w2dc-scrollable-block')) {
			...
			if (scroll_to_anchor.length) {
				scroll_to_anchor.parent().parent().animate({
					scrollTop: scroll_to_anchor.position().top - sticky_scroll_toppadding
				}, 'slow');
			}
		}
	}
...
if ("undefined" == typeof jQuery) throw new Error("Bootstrap's JavaScript requires jQuery"); + function (t) {
	...
	if (e[0] < 2 && e[1] < 9 || 1 == e[0] && 9 == e[1] && e[2] < 1) {
		alert("Bootstrap's JavaScript requires jQuery version 1.9.1 or higher. Your theme uses old version of jQuery library instead of using a file that is included into wordpress. Update of theme may fix the issue or contact developers of the theme.");
	...
	function e(e) {
		return this.each(function () {
			var o = t(this),
				n = o.data("bs.w2dc-tooltip"),
				s = "object" == typeof e && e;
			(n || !/destroy|hide/.test(e)) && (n || o.data("bs.w2dc-tooltip", n = new i(this, s)), "string" == typeof e && n[e]())
		})
	}
	var i = function (t, e) {
		this.type = null, this.options = null, this.enabled = null, this.timeout = null, this.hoverState = null, this.$element = null, this.inState = null, this.init("w2dc_tooltip", t, e)
	};
	i.VERSION = "3.3.5", i.TRANSITION_DURATION = 150, i.DEFAULTS = {
		animation: !0,
		placement: "top",
		selector: !1,
		template: '<div class="w2dc-tooltip" role="w2dc-tooltip"><div class="w2dc-tooltip-arrow"></div><div class="w2dc-tooltip-inner"></div></div>',
		trigger: "hover focus",
		title: "",
		delay: 0,
		html: !1,
		...
		return i || (i = new this.constructor(e.currentTarget, this.getDelegateOptions()), t(e.currentTarget).data("bs." + this.type, i)), e instanceof t.Event && (i.inState["focusin" == e.type ? "focus" : "hover"] = !0), i.tip().hasClass("w2dc-in") || "in" == i.hoverState ? void(i.hoverState = "in") : (clearTimeout(i.timeout), i.hoverState = "in", i.options.delay && i.options.delay.show ? void(i.timeout = setTimeout(function () {
		...
		if (this.hasContent() && this.enabled) {
			...
			this.setContent(), s.attr("id", r), this.$element.attr("aria-describedby", r), this.options.animation && s.addClass("w2dc-fade");
			...
			h && (a = a.replace(l, "") || "top"), s.detach().css({
				...
				left: 0,
				display: "block"
			}).addClass("w2dc-" + a).data("bs." + this.type, this), this.options.container ? s.appendTo(this.options.container) : s.insertAfter(this.$element), this.$element.trigger("inserted.bs." + this.type);
			...
			t.support.transition && this.$tip.hasClass("w2dc-fade") ? s.one("bsTransitionEnd", v).emulateTransitionEnd(i.TRANSITION_DURATION) : v()
		}
		...
		var t = this.tip(),
			e = this.getTitle();
		t.find(".w2dc-tooltip-inner")[this.options.html ? "html" : "text"](e), t.removeClass("w2dc-fade w2dc-in w2dc-top w2dc-bottom w2dc-left w2dc-right")
		...
		return this.$element.trigger(r), r.isDefaultPrevented() ? void 0 : (s.removeClass("w2dc-in"), t.support.transition && s.hasClass("w2dc-fade") ? s.one("bsTransitionEnd", o).emulateTransitionEnd(i.TRANSITION_DURATION) : o(), this.hoverState = null, this)
		...
		var i = this;
		e && (i = t(e.currentTarget).data("bs." + this.type), i || (i = new this.constructor(e.currentTarget, this.getDelegateOptions()), t(e.currentTarget).data("bs." + this.type, i))), e ? (i.inState.click = !i.inState.click, i.isInStateTrue() ? i.enter(i) : i.leave(i)) : i.tip().hasClass("w2dc-in") ? i.leave(i) : i.enter(i)
	...
	var o = t.fn.w2dc_tooltip;
	t.fn.w2dc_tooltip = e, t.fn.w2dc_tooltip.Constructor = i, t.fn.w2dc_tooltip.noConflict = function () {
		return t.fn.w2dc_tooltip = o, this
	}
}(jQuery), + function (t) {
	"use strict";
	...
	function e(e) {
		return this.each(function () {
			var o = t(this),
				n = o.data("bs.w2dc-popover"),
				s = "object" == typeof e && e;
			(n || !/destroy|hide/.test(e)) && (n || o.data("bs.w2dc-popover", n = new i(this, s)), "string" == typeof e && n[e]())
		})
	}
	var i = function (t, e) {
		this.init("w2dc-popover", t, e)
	};
	if (!t.fn.w2dc_tooltip) throw new Error("w2dc-popover requires w2dc-tooltip.js");
	i.VERSION = "3.3.5", i.DEFAULTS = t.extend({}, t.fn.w2dc_tooltip.Constructor.DEFAULTS, {
		placement: "right",
		trigger: "click",
		content: "",
		template: '<div class="w2dc-popover" role="w2dc-tooltip"><div class="arrow"></div><h3 class="w2dc-popover-title"></h3><div class="w2dc-popover-content"></div></div>'
	}), i.prototype = t.extend({}, t.fn.w2dc_tooltip.Constructor.prototype), i.prototype.constructor = i, i.prototype.getDefaults = function () {
		return i.DEFAULTS
	}, i.prototype.setContent = function () {
		var t = this.tip(),
			e = this.getTitle(),
			i = this.getContent();
		t.find(".w2dc-popover-title")[this.options.html ? "html" : "text"](e), t.find(".w2dc-popover-content").children().detach().end()[this.options.html ? "string" == typeof i ? "html" : "append" : "text"](i), t.removeClass("w2dc-fade w2dc-top w2dc-bottom w2dc-left w2dc-right w2dc-in"), t.find(".w2dc-popover-title").html() || t.find(".w2dc-popover-title").hide()
	}, i.prototype.hasContent = function () {
	...
	var o = t.fn.w2dc_popover;
	t.fn.w2dc_popover = e, t.fn.w2dc_popover.Constructor = i, t.fn.w2dc_popover.noConflict = function () {
		return t.fn.w2dc_popover = o, this
	}
}(jQuery), + function (t) {
	"use strict";
	...
	function e(e) {
		return this.each(function () {
			var o = t(this),
				n = o.data("bs.w2dc-affix"),
				s = "object" == typeof e && e;
			n || o.data("bs.w2dc-affix", n = new i(this, s)), "string" == typeof e && n[e]()
		})
	}
	var i = function (e, o) {
	...
	i.VERSION = "3.3.5", i.RESET = "affix affix-top affix-bottom", i.DEFAULTS = {
		...
		this.$element.removeClass(i.RESET).addClass("w2dc-affix");
...
! function (e) {
	...
	e.tokenize = function (t) {
		...
		init: function (t) {
			...
			this.select = t.attr("multiple", "multiple").css({
			...
			}).disableSelection() : (this.options.sortable = !1, console.log("jQuery UI is not loaded, sortable option has been disabled"))), this.container.append(this.tokensContainer).append(this.dropdown).insertAfter(this.select), this.tokensContainer.on("click", function (e) {
				...
				setTimeout(function () {
					...
					t.length > 1 && e.each(t, function (e, t) {
						n.tokenAdd(t.trim(), "")
					})
				}, 20)
		...
		updatePlaceholder: function () {
			0 != this.options.placeholder && (void 0 == this.placeholder && (this.placeholder = e("<li />").addClass("Placeholder").html(this.options.placeholder), this.placeholder.insertBefore(e("li:first-child", this.tokensContainer))), 0 == this.searchInput.val().length && 0 == e("li.Token", this.tokensContainer).length ? this.placeholder.show() : this.placeholder.hide())
		},
		...
		keydown: function (n) {
			switch (n.keyCode) {
				case t.BACKSPACE:
					0 == this.searchInput.val().length && (n.preventDefault(), e("li.Token.PendingDelete", this.tokensContainer).length ? this.tokenRemove(e("li.Token.PendingDelete").attr("data-value")) : e("li.Token:last", this.tokensContainer).addClass("PendingDelete"), this.dropdownHide());
					break;
				case t.TAB:
				case t.ENTER:
		...
		search: function () {
			...
			if ("select" == this.options.datas) {
				...
				this.dropdownReset(), e("option", this.select).not(":selected, :disabled").each(function () {
					return n <= t.options.nbDropdownElements ? void(s.test(e(this).html()) && (t.dropdownAddItem(e(this).attr("value"), e(this).html()), o = !0, n++)) : !1
				...
				e.ajax({
					...
					success: function (o) {
						return o && (t.dropdownReset(), e.each(o, function (e, o) {
						...
						}), e("li", t.dropdown).length) ? (e("li:first", t.dropdown).addClass("Hover"), t.dropdownShow(), !0) : void t.dropdownHide()
					},
					error: function (e, t) {
						console.log("Error : " + t)
					}
		...
		tokenAdd: function (t, n, o) {
			...
			if ((void 0 == n || "" == n) && (n = t), void 0 == o && (o = !1), this.options.maxElements > 0 && e("li.Token", this.tokensContainer).length >= this.options.maxElements) return this.resetSearchInput(), this;
			var s = this,
				i = e("<a />").addClass("Close").html("&#215;").on("click", function (e) {
					e.stopImmediatePropagation(), s.tokenRemove(t)
				});
			if (e('option[value="' + t + '"]', this.select).length) e('option[value="' + t + '"]', this.select).attr("selected", !0).prop("selected", !0);
			else {
				...
				var a = e("<option />").attr("selected", !0).attr("value", t).attr("data-type", "custom").prop("selected", !0).html(n);
				this.select.append(a)
			}
			return e('li.Token[data-value="' + t + '"]', this.tokensContainer).length > 0 ? this : (e("<li />").addClass("Token").attr("data-value", t).append("<span>" + n + "</span>").prepend(i).insertBefore(this.searchToken), o || this.options.onAddToken(t, n, this), this.resetSearchInput(), this.dropdownHide(), this.updateOrder(), this)
		},
		...
		remap: function (t) {
			...
			return void 0 == t && (t = !1), this.clear(), o.each(function () {
		...
		return n.length > 1 ? (n.each(function () {
			s(t, e(this))
		}), n) : s(t, e(this))
