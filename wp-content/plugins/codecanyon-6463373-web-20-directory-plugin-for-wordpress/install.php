...
function w2dc_install_directory() {
	...
	if (!get_option('w2dc_installed_directory')) {
		...
		add_option('w2dc_preexpiration_notification', 'Your listing "[listing]" will expiry in [days] days. You can renew it here [link]');
