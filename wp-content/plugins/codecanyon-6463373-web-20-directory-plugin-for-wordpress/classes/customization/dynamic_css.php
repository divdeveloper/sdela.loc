...
.w2dc-content.w2dc-search-form {
	background: <?php echo w2dc_hex2rgba(w2dc_get_dynamic_option('w2dc_search_1_color'), w2dc_get_dynamic_option('w2dc_search_bg_opacity')/100); ?>;
	background: -moz-linear-gradient(top, <?php echo w2dc_hex2rgba(w2dc_get_dynamic_option('w2dc_search_1_color'), w2dc_get_dynamic_option('w2dc_search_bg_opacity')/100); ?> 0%, <?php echo w2dc_hex2rgba(w2dc_get_dynamic_option('w2dc_search_2_color'), w2dc_get_dynamic_option('w2dc_search_bg_opacity')/100); ?> 100%);
	background: -webkit-gradient(linear, left top, left bottom, color-stop(0%, <?php echo w2dc_hex2rgba(w2dc_get_dynamic_option('w2dc_search_1_color'), w2dc_get_dynamic_option('w2dc_search_bg_opacity')/100); ?>), color-stop(100%, <?php echo w2dc_hex2rgba(w2dc_get_dynamic_option('w2dc_search_2_color'), w2dc_get_dynamic_option('w2dc_search_bg_opacity')/100); ?>));
	background: -webkit-linear-gradient(top, <?php echo w2dc_hex2rgba(w2dc_get_dynamic_option('w2dc_search_1_color'), w2dc_get_dynamic_option('w2dc_search_bg_opacity')/100); ?> 0%, <?php echo w2dc_hex2rgba(w2dc_get_dynamic_option('w2dc_search_2_color'), w2dc_get_dynamic_option('w2dc_search_bg_opacity')/100); ?> 100%);
	background: -o-linear-gradient(top, <?php echo w2dc_hex2rgba(w2dc_get_dynamic_option('w2dc_search_1_color'), w2dc_get_dynamic_option('w2dc_search_bg_opacity')/100); ?> 0%, <?php echo w2dc_hex2rgba(w2dc_get_dynamic_option('w2dc_search_2_color'), w2dc_get_dynamic_option('w2dc_search_bg_opacity')/100); ?> 100%);
	background: -ms-linear-gradient(top, <?php echo w2dc_hex2rgba(w2dc_get_dynamic_option('w2dc_search_1_color'), w2dc_get_dynamic_option('w2dc_search_bg_opacity')/100); ?> 0%, <?php echo w2dc_hex2rgba(w2dc_get_dynamic_option('w2dc_search_2_color'), w2dc_get_dynamic_option('w2dc_search_bg_opacity')/100); ?> 100%);
	background: linear-gradient(to bottom, <?php echo w2dc_hex2rgba(w2dc_get_dynamic_option('w2dc_search_1_color'), w2dc_get_dynamic_option('w2dc_search_bg_opacity')/100); ?> 0%, <?php echo w2dc_hex2rgba(w2dc_get_dynamic_option('w2dc_search_2_color'), w2dc_get_dynamic_option('w2dc_search_bg_opacity')/100); ?> 100%);
	filter: progid:DXImageTransform.Microsoft.gradient( startColorstr= <?php echo w2dc_hex2rgba(w2dc_get_dynamic_option('w2dc_search_1_color'), w2dc_get_dynamic_option('w2dc_search_bg_opacity')/100); ?> , endColorstr= <?php echo w2dc_hex2rgba(w2dc_get_dynamic_option('w2dc_search_2_color'), w2dc_get_dynamic_option('w2dc_search_bg_opacity')/100); ?> ,GradientType=0 );
}
<?php endif; ?>
